...
3. Predict nodule attributes (e.g. size, malignancy) in abnormal regions
...
The vast majority of every CT scan is not useful in diagnosing lung cancer. There are several reasons for this, but first is that much of the CT scan data is covering locations outside the lungs! Below is a .gif of a CT scan showing 'interior' regions in yellow.
