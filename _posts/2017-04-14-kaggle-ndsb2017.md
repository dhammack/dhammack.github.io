...
Data augmentation is a crucial but subtle part of my solution. It's the reason that I was able to build models on only 1200 nodules and have them work very well (normal computer vision datasets have 10,000 - 10,000,000 images). 
